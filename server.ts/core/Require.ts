...
export default function Require(pathToModule: string, _arguments?: RequireArguments, clearCache?: boolean) {
        ...
        try {
            if (_arguments) {
                ...
                if (typeof _module === "function" ) {
                    _module.call(_argValues[0], _argValues[1], _argValues[2], _argValues[3], _argValues[4],
